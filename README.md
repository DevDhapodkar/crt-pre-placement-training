...
* Implements robust exception handling using `try-catch` blocks and showcases catching standard run-time exceptions like `ArithmeticException` (`Example1.java`), `NullPointerException` (`Example2.java`), and `ArrayIndexOutOfBoundsException` (`Example3.java`).
